...
describe('utf8/byte helpers', () => {
  ...
  it('round-trips byte arrays through hex', () => {
    ...
    expect(bytesToHex(Uint8Array.from([0x0a, 0x1b, 0xff]), true)).toBe('0A1BFF');
  });
...
describe('URL encoding', () => {
  ...
  it('leaves unreserved characters intact', () => {
    expect(urlEncode('ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_.~')).toBe(
